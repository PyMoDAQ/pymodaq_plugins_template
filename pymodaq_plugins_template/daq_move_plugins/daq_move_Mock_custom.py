...
class DAQ_Move_Mock_custom(DAQ_Move_base):
    """
    ...
    params= [#elements to be added in order to control your custom stage
              {'title': 'Tau (ms):', 'name': 'tau', 'type': 'int', 'value': 10000},
    ...
    def check_position(self):
        ...
        pos = (self.current_position-self.target_position *
               np.exp((-elapsed_time / self.settings.child('tau').value()))) + self.target_position
